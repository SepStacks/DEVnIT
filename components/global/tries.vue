...
// Import dynamic path
import { html, css, js } from "../../assets/compSourceCode/tries";
...
export default {
  ...
  //Import Local js file by component name
  //  import('../../assets/compSourceCode/tries' ).then(module => {
  //     const {html, css, js} = module
  //     this.html = html
  //       this.css = css
  //         this.js = js
  //  })
